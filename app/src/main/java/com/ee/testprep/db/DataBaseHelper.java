    ...
    public List<Test> getTestsData(Context context, TestType testType) {
        ...
        if (testType == TestType.QBANK) {
            ...
            for (String subject : subjects) {
                ...
                tests.add(new Test(subject, subject, maxQuestions, answeredQuestions, correctAnswers, wrongAnswers, 0));
            }
            ...
            for (MetaData quiz : quizzes) {
                ...
                tests.add(new Test(quiz.mName, quiz.mSubject, maxQuestions, answeredQuestions, correctAnswers, wrongAnswers, 0));
            }
